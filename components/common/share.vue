						...
						if (iClickIndex >= 0 && iClickIndex <= 5) { //处理具体的点击逻辑，此处也可以自行定义逻辑。如果增减了按钮，此处也需要跟着修改
							...
							switch (iClickIndex) {
								...
								case 4:
									uni.setClipboardData({
										data: this.shareObj.strShareUrl,
										complete() {
											uni.showToast({
												title: "已复制到剪贴板"
											})
								...
								case 5:
									plus.share.sendWithSystem({
										content: this.shareObj.strShareUrl,
									})
									break;
							}
							if (strProvider!="") { //点击了0-3序号的这4个按钮
								uni.share({
									...
									scene: strScene,
									type: 0,
									href: this.shareObj.strShareUrl,
									title: this.shareObj.strShareTitle,
									summary: this.shareObj.strShareSummary,
									imageUrl: this.shareObj.strShareImageUrl,
